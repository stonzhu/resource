  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="财务编码" prop="financeCode">
        <el-input
          v-model="queryParams.financeCode"
          placeholder="请输入财务编码"
          clearable
      ...
      <el-form-item label="公用or专用" prop="isPublic">
        <el-input
          v-model="queryParams.isPublic"
          placeholder="请输入公用or专用"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除办公用品商品编号为"' + goodsIds + '"的数据项？').then(function() {
