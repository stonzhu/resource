  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="交还人" prop="returnPeople">
        <el-input
          v-model="queryParams.returnPeople"
          placeholder="请输入交还人"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['return:returnRecord:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['return:returnRecord:edit']"
        >修改</el-button>
      </el-col>
<!--      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['return:returnRecord:remove']"
        >删除</el-button>
      </el-col>-->
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['return:returnRecord:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="returnRecordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="交还数量" align="center" prop="quantity" />
      <el-table-column label="交还人" align="center" prop="returnPeople" />
      <el-table-column label="交还时间" align="center" prop="returnTime" width="180">
      ...
      <el-table-column label="交还原因" align="center" prop="reason" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="商品名称" prop="goodsName">
          <el-input v-model="form.goodsName" placeholder="请选择商品名称" />
        </el-form-item>
        <el-form-item label="规格型号" prop="normsModel">
...
<script>
import { listReturnRecord, getReturnRecord, delReturnRecord, addReturnRecord, updateReturnRecord } from "@/api/wms/returnRecord";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        quantity: [
          { required: true, message: "交还数量不能为空", trigger: "blur" }
        ],
        returnPeople: [
          { required: true, message: "交还人不能为空", trigger: "blur" }
        ],
        returnTime: [
          { required: true, message: "交还时间不能为空", trigger: "blur" }
        ],
        handover: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除交还记录编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('return/returnRecord/export', {
        ...this.queryParams
